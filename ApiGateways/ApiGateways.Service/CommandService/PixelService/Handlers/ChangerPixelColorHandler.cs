...
{
    public class ChangerPixelColorHandler : HandlerBase<ChangerPixelColorCommand, ResultWithError<List<ChangePixelColorResponse>>>
    {
        ...
        protected override async Task<ResultWithError<List<ChangePixelColorResponse>>> Execute(ChangerPixelColorCommand request, CancellationToken cancellationToken)
        {
